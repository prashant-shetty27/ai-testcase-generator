...
KNOWN_MODULES = {
    ...
    "leads", "notifications", "sync", "integrations",
}
...
Module values must be from: login, search, catalogue, verticals, profile, payment gateway, reviews ratings, chatbot, kyc, contract, movies, restaurants, real estate, healthcare, home services, beauty, education, hotels, jobs, finance, legal, matrimony, pets, events, leads, notifications, sync, integrations.
